/* What is left of ui_devices.c while it is being split into ctm_enumerate.c,
 * ctm_classify.c, ctm_dev_composite.c and ctm_model.c: the sysfs scan, the
 * classification predicates and the logical-device model. The composite/Flydigi
 * half has already moved to ctm_dev_composite.c. */
