/* What is left of ui_devices.c while it is being split: the sysfs scan and the
 * logical-device model. The composite/Flydigi half is now in
 * ctm_dev_composite.c and the classification predicates in ctm_classify.c. */
